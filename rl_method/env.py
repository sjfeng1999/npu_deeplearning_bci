...
# calculate cosine distance v<a> v<b>
...
# Drop channel from data and return reward
# method follow paradigm
class DropEnv:
    def __init__(self,
                 data,
                 label,
    ...
    def step(self, action):
        ...
        if reward < 0 and (
                self.random_drop == True and random.random() < self.random_stop or self.random_drop == False):
            done = True
